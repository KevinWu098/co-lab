    ...
    <div className="flex flex-1 flex-row gap-4 py-4">
      <div className="flex w-full flex-1 flex-col gap-4">
        <div className="grid grid-cols-3">
          <DataCard title="Temperature" values={[36.8, 36.9, 37.0, 37.1, 36.9, 37.0, 37.1, 37.2]} unit="°C" />
          <DataCard title="Pressure" values={[1.015, 1.014, 1.014, 1.013, 1.012, 1.013]} unit="atm" />
